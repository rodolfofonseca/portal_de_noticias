                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="pais_cad.php" class="dropdown-item">Pais</a>
                            <a href="estado_cad.php" class="dropdown-item">Estado</a>
                            <a href="cidade_cad.php" class="dropdown-item">Cidade</a>
                            <a href="bairro_cad.php" class="dropdown-item">Bairro</a>
                            <a href="rua_cad.php" class="dropdown-item">Rua</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="pais_pesq.php" class="dropdown-item">Pais</a>
                            <a href="estado_pesq.php" class="dropdown-item">Estado</a>
                            <a href="cidade_pesq.php" class="dropdown-item">Cidade</a>
                            <a href="bairro_pesq.php" class="dropdown-item">Bairro</a>
