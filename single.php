        ...
        <div class="row align-items-center py-2 px-lg-5">
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-lg-block">
                    <h1 class="m-0 display-5 text-uppercase"><span class="text-primary">ASSPOL</span> Associação Polícial</h1>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid p-0 mb-3">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-2 py-lg-0 px-lg-5">
            <a href="" class="navbar-brand d-block d-lg-none">
                <h1 class="m-0 display-5 text-uppercase"><span class="text-primary">ASSPOL</span>Associação Policial</h1>
            </a>
    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <a class="breadcrumb-item" href="#">Tecnologia</a>
                <span class="breadcrumb-item active">Boeing compra 7,5 milhões de litros...</span>
            </nav>
        </div>
    </div>
    <!-- Breadcrumb End -->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <div class="overlay position-relative bg-light">
                            ...
                            <div>
                                <h3 class="mb-3">Boeing compra 7,5 milhões de litros...</h3>
                    ...
                    <div class="bg-light mb-3" style="padding: 30px;">
                        <h3 class="mb-4">3 Comentários</h3>
